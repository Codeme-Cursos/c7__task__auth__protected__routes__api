...
var sequelize = new _sequelize["default"](process.env.DB_NAME, //Nombre de Base de Datos de Postgres
...
process.env.DB_PASSWORD, //Contraseña de Postgres
{
  ...
  //Tecnología SQL que estoy usando
  protocol: process.env.DB_PROTOCOL,
  pool: {
    //Configuración recomendada por sequelize en su documentación
    max: 5,
    min: 0,
    acquire: 30000,
    idle: 10000
